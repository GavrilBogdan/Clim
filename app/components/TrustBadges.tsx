...
const Badge = ({ icon, text }: any) => (
  <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-white/40 backdrop-blur-xl border border-green-200/40 shadow-sm cursor-pointer hover:scale-105 transition-all duration-150 hover:shadow-xs hover:shadow-green-700">
    <div className="p-2 bg-green-600/10 rounded-xl text-green-700">{icon}</div>
